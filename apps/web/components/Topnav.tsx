      ...
      <div className="flex items-center gap-6">
        ...
        <div className="flex items-center gap-3 pl-6 border-l border-gray-100">
          <div className="text-right hidden md:block">
            ...
            <p className="text-xs text-gray-500 font-medium tracking-wide">Continental PE</p>
          </div>
          ...
          <button onClick={logout} className="ml-2 p-2 text-gray-400 hover:text-red-600 transition-colors rounded-full hover:bg-red-50" title="Sign Out">
